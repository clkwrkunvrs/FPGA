...
HD_PWD='/home/fpga/FPGA/Vivado/seven_seg_rtc/seven_seg_rtc.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log seven_seg_rtc.vds -m64 -mode batch -messageDb vivado.pb -notrace -source seven_seg_rtc.tcl
