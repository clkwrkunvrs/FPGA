...
HD_PWD='/home/fpga/FPGA/Vivado/seven_seg_rtc/seven_seg_rtc.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log seven_seg_rtc.vdi -applog -m64 -messageDb vivado.pb -mode batch -source seven_seg_rtc.tcl -notrace
