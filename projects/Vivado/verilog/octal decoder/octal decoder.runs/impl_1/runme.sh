...
HD_PWD='/home/fpga/FPGA/Vivado/octal decoder/octal decoder.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log octal_decoder_top.vdi -applog -m64 -messageDb vivado.pb -mode batch -source octal_decoder_top.tcl -notrace
