...
HD_PWD='/home/fpga/FPGA/Vivado/octal decoder/octal decoder.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log octal_decoder_top.vds -m64 -mode batch -messageDb vivado.pb -notrace -source octal_decoder_top.tcl
